        ...
        return this.each(function () {
            ...
            self.on('change', function (event) {
                ...
                if (input.attr('checked') === 'checked') {
                    ...
                    if (input.attr('id') == "display_profile") {
                        $.ajax({
                            type: 'POST',
                            url: 'ajax.php',
                            data: {target: 'ProfileShow'},
                            dataType: 'html',
                            success: function (data) {
                            }
                        });
                    }
                    else if (input.attr('id') == "display_realtime") {
                        $.ajax({
                            type: 'POST',
                            url: 'ajax.php',
                            data: {target: 'RealTimeShow'},
                            dataType: 'html',
                            success: function (data) {
                            }
                        });
