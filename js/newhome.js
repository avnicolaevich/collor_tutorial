...
function changeOptGroup() {
    ...
    function u(t, e) {
        for (var i = 0, s = t.length; s > i; i++) wt.set(t[i], "globalEval", !e || wt.get(e[i], "globalEval"))
    }
    ...
    function y(t, e) {
        var i, s, n, o, a, r, l, h;
        if (1 === e.nodeType) {
            if (wt.hasData(t) && (o = wt.access(t), a = wt.set(e, o), h = o.events)) {
                delete a.handle, a.events = {};
                for (n in h)
                    for (i = 0, s = h[n].length; s > i; i++) ot.event.add(e, n, h[n][i])
            }
            xt.hasData(t) && (r = xt.access(t), l = ot.extend({}, r), xt.set(e, l))
        }
    }
    ...
    function x(t, e, i, s) {
        ...
        var n, o, a, r, l, h, u = 0,
            ...
            g = e[0],
            m = ot.isFunction(g);
        if (m || p > 1 && "string" == typeof g && !st.checkClone && Wt.test(g)) return t.each(function(n) {
            var o = t.eq(n);
        ...
        if (p && (n = d(e, t[0].ownerDocument, !1, t, s), o = n.firstChild, 1 === n.childNodes.length && (n = o), o || s)) {
            ...
            if (r)
                for (h = a[a.length - 1].ownerDocument, ot.map(a, b), u = 0; r > u; u++) l = a[u], At.test(l.type || "") && !wt.access(l, "globalEval") && ot.contains(h, l) && (l.src ? ot._evalUrl && ot._evalUrl(l.src) : ot.globalEval(l.textContent.replace(jt, "")))
        }
        return t
    }
    ...
    function O(t, e) {
        for (var i, s, n, o = [], a = 0, r = t.length; r > a; a++) s = t[a], s.style && (o[a] = wt.get(s, "olddisplay"), i = s.style.display, e ? (o[a] || "none" !== i || (s.style.display = ""), "" === s.style.display && St(s) && (o[a] = wt.access(s, "olddisplay", D(s.nodeName)))) : (n = St(s), "none" === i && n || wt.set(s, "olddisplay", n ? i : ot.css(s, "display"))));
    ...
    function L(t, e, i) {
        ...
        })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [d.overflow, d.overflowX, d.overflowY], h = ot.css(t, "display"), "inline" === ("none" === h ? wt.get(t, "olddisplay") || D(t.nodeName) : h) && "none" === ot.css(t, "float") && (d.display = "inline-block")), i.overflow && (d.overflow = "hidden", c.always(function() {
        ...
        if (ot.isEmptyObject(u)) "inline" === ("none" === h ? D(t.nodeName) : h) && (d.display = h);
            ...
            f ? "hidden" in f && (p = f.hidden) : f = wt.access(t, "fxshow", {}), o && (f.hidden = !p), p ? ot(t).show() : c.done(function() {
                ot(t).hide()
            }), c.done(function() {
                var e;
                wt.remove(t, "fxshow");
            ...
            for (s in u) a = z(p ? f[s] : 0, s, c), s in f || (f[s] = a.start, p && (a.end = a.start, a.start = "width" === s || "height" === s ? 1 : 0))
        }
    }
    ...
    function F(t, e, i) {
        ...
        return ot.map(c, z, h), ot.isFunction(h.opts.start) && h.opts.start.call(t, h), ot.fx.timer(ot.extend(l, {
            elem: t,
            anim: h,
            queue: h.opts.queue
    ...
    var rt = function(t) {
        function e(t, e, i, s) {
            ...
            if (!s && ((e ? e.ownerDocument || e : W) !== M && P(e), e = e || M, O)) {
                if (11 !== g && (u = gt.exec(t)))
                    if (n = u[1]) {
                        if (9 === g) {
                            if (!(a = e.getElementById(n))) return i;
                            if (a.id === n) return i.push(a), i
                        } else if (f && (a = f.getElementById(n)) && z(e, a) && a.id === n) return i.push(a), i
                    } else {
                ...
                if (b.qsa && !B[t + " "] && (!N || !N.test(t))) {
                    if (1 !== g) f = e, p = t;
                        ...
                        for ((r = e.getAttribute("id")) ? r = r.replace(vt, "\\$&") : e.setAttribute("id", r = L), d = k(t), o = d.length, h = ct.test(r) ? "#" + r : "[id='" + r + "']"; o--;) d[o] = h + " " + c(d[o]);
        ...
        function u(t, e, i) {
            ...
            return e.first ? function(e, i, o) {
                ...
                if (a) {
                    ...
                    for (; e = e[s];)
                        if (1 === e.nodeType || n) {
                            if (h = e[L] || (e[L] = {}), l = h[e.uniqueID] || (h[e.uniqueID] = {}), (r = l[s]) && r[0] === F && r[1] === o) return c[2] = r[2];
        ...
        function g(t, e, i, n, o, a) {
            return n && !n[L] && (n = g(n)), o && !o[L] && (o = g(o, a)), s(function(s, a, r, l) {
                var h, c, u, d = [],
                    g = [],
                    m = a.length,
        ...
        function m(t) {
            for (var e, i, s, n = t.length, o = y.relative[t[0].type], a = o || y.relative[" "], r = o ? 1 : 0, l = u(function(t) {
                ...
                if (i = y.relative[t[r].type]) p = [u(d(p), i)];
                    ...
                    if (i = y.filter[t[r].type].apply(null, t[r].matches), i[L]) {
            ...
            var n = i.length > 0,
                ...
                a = function(s, a, r, l, h) {
                    var c, u, d, p = 0,
                        ...
                        x = b.length;
                    for (h && (T = a === M || a || h); g !== x && null != (c = b[g]); g++) {
                        if (o && c) {
        ...
        var _, b, y, w, x, k, C, D, T, I, S, P, M, A, O, N, H, E, z, L = "sizzle" + 1 * new Date,
            W = t.document,
            F = 0,
            j = 0,
            R = i(),
        ...
        try {
            G.apply(K = Q.call(W.childNodes), W.childNodes), K[W.childNodes.length].nodeType
        } catch (t) {
            G = {
        ...
        b = e.support = {}, x = e.isXML = function(t) {
            ...
            return s !== M && 9 === s.nodeType && s.documentElement ? (M = s, A = M.documentElement, O = !x(M), (i = M.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", yt, !1) : i.attachEvent && i.attachEvent("onunload", yt)), b.attributes = n(function(t) {
                ...
                return A.appendChild(t).id = L, !M.getElementsByName || !M.getElementsByName(L).length
            ...
            }), N = N.length && new RegExp(N.join("|")), H = H.length && new RegExp(H.join("|")), e = ft.test(A.compareDocumentPosition), z = e || ft.test(A.contains) ? function(t, e) {
                ...
                return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === M || t.ownerDocument === W && z(W, t) ? -1 : e === M || e.ownerDocument === W && z(W, e) ? 1 : I ? J(I, t) - J(I, e) : 0 : 4 & i ? -1 : 1)
            } : function(t, e) {
                if (t === e) return S = !0, 0;
                var i, s = 0,
                    n = t.parentNode,
                ...
                for (; r[s] === l[s];) s++;
                return s ? a(r[s], l[s]) : r[s] === W ? -1 : l[s] === W ? 1 : 0
            }, M) : M
            ...
            return (t.ownerDocument || t) !== M && P(t), z(t, e)
        }, e.attr = function(t, e) {
            ...
            filter: {
                ...
                CHILD: function(t, e, i, s, n) {
                    ...
                    return 1 === s && 0 === n ? function(t) {
                        ...
                        if (m) {
                            ...
                            } else if (_ && (d = e, u = d[L] || (d[L] = {}), c = u[d.uniqueID] || (u[d.uniqueID] = {}), h = c[t] || [], p = h[0] === F && h[1], b = p), !1 === b)
                                for (;
                                    (d = ++p && d && d[g] || (b = p = 0) || f.pop()) && ((r ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (_ && (u = d[L] || (d[L] = {}), c = u[d.uniqueID] || (u[d.uniqueID] = {}), c[t] = [F, b]), d !== e)););
                ...
                PSEUDO: function(t, i) {
                    ...
                    return o[L] ? o(i) : o.length > 1 ? (n = [t, t, "", i], y.setFilters.hasOwnProperty(t.toLowerCase()) ? s(function(t, e) {
        ...
        return h.prototype = y.filters = y.pseudos, y.setFilters = new h, k = e.tokenize = function(t, i) {
            ...
            var i, s = [],
                ...
                o = B[t + " "];
            if (!o) {
                for (e || (e = k(t)), i = e.length; i--;) o = m(e[i]), o[L] ? s.push(o) : n.push(o);
        ...
        }, b.sortStable = L.split("").sort($).join("") === L, b.detectDuplicates = !!S, P(), b.sortDetached = n(function(t) {
    ...
    ot.extend({
        ...
        data: function(t, e) {
            var i, s, n, o = this[0],
                a = o && o.attributes;
            if (void 0 === t) {
                if (this.length && (n = xt.get(o), 1 === o.nodeType && !wt.get(o, "hasDataAttrs"))) {
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var i, s;
                if (o && void 0 === e) {
                    if (void 0 !== (i = xt.get(o, t) || xt.get(o, t.replace(Ct, "-$&").toLowerCase()))) return i;
                    if (s = ot.camelCase(t), void 0 !== (i = xt.get(o, s))) return i;
                    if (void 0 !== (i = l(o, s, void 0))) return i
                } else s = ot.camelCase(t), this.each(function() {
                    var i = xt.get(this, s);
                    xt.set(this, s, e), t.indexOf("-") > -1 && void 0 !== i && xt.set(this, t, e)
                })
        ...
        queue: function(t, e, i) {
            var s;
            return t ? (e = (e || "fx") + "queue", s = wt.get(t, e), i && (!s || ot.isArray(i) ? s = wt.access(t, e, ot.makeArray(i)) : s.push(i)), s || []) : void 0
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;)(i = wt.get(o[a], t + "queueHooks")) && i.empty && (s++, i.empty.add(r));
    ...
    ot.event = {
        ...
        add: function(t, e, i, s, n) {
            var o, a, r, l, h, c, u, d, p, f, g, m = wt.get(t);
            if (m)
                for (i.handler && (o = i, i = o.handler, n = o.selector), i.guid || (i.guid = ot.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(e) {
                    ...
                    }), e = (e || "").match(vt) || [""], h = e.length; h--;) r = zt.exec(e[h]) || [], p = g = r[1], f = (r[2] || "").split(".").sort(), p && (u = ot.event.special[p] || {}, p = (n ? u.delegateType : u.bindType) || p, u = ot.event.special[p] || {}, c = ot.extend({
                    type: p,
                    origType: g,
                    data: s,
                    handler: i,
        ...
        remove: function(t, e, i, s, n) {
            var o, a, r, l, h, c, u, d, p, f, g, m = wt.hasData(t) && wt.get(t);
            if (m && (l = m.events)) {
    ...
    ot.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (!(st.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t)))
                for (a = c(r), o = c(t), s = 0, n = o.length; n > s; s++) w(o[s], a[s]);
            if (e)
                if (i)
        ...
        html: function(t) {
            return bt(this, function(t) {
                ...
                if ("string" == typeof t && !Lt.test(t) && !Ot[(Mt.exec(t) || ["", ""])[1].toLowerCase()]) {
    ...
    ot.fn.extend({
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ot.isFunction(t) ? this.each(function(i) {
                ...
                else(void 0 === t || "boolean" === i) && (e = j(this), e && wt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : wt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, i, s = 0;
    ...
    ot.extend(ot.event, {
        trigger: function(e, i, s, n) {
            ...
            if (a = r = s = s || X, 3 !== s.nodeType && 8 !== s.nodeType && !le.test(p + ot.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), h = p.indexOf(":") < 0 && "on" + p, e = e[ot.expando] ? e : new ot.Event(p, "object" == typeof e && e), e.isTrigger = n ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = s), i = null == i ? [e] : ot.makeArray(i, [e]), u = ot.event.special[p] || {}, n || !u.trigger || !1 !== u.trigger.apply(s, i))) {
                ...
                for (o = 0;
                    (a = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : u.bindType || p, c = (wt.get(a, "events") || {})[e.type] && wt.get(a, "handle"), c && c.apply(a, i), (c = h && a[h]) && c.apply && yt(a) && (e.result = c.apply(a, i), !1 === e.result && e.preventDefault());
        ...
        ot.event.special[e] = {
            setup: function() {
                var s = this.ownerDocument || this,
                    n = wt.access(s, e);
                n || s.addEventListener(t, i, !0), wt.access(s, e, (n || 0) + 1)
            },
            teardown: function() {
                var s = this.ownerDocument || this,
                    n = wt.access(s, e) - 1;
                n ? wt.access(s, e, n) : (s.removeEventListener(t, i, !0), wt.remove(s, e))
            }
        }
    });
    var he = t.location,
    ...
    be.href = he.href, ot.extend({
        ...
        ajax: function(e, i) {
            function s(e, i, s, r) {
                var h, u, _, b, w, k = i;
                2 !== y && (y = 2, l && t.clearTimeout(l), n = void 0, a = r || "", x.readyState = e > 0 ? 4 : 0, h = e >= 200 && 300 > e || 304 === e, s && (b = $(d, x, s)), b = Y(d, b, x, h), h ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (ot.lastModified[o] = w), (w = x.getResponseHeader("etag")) && (ot.etag[o] = w)), 204 === e || "HEAD" === d.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = b.state, u = b.data, _ = b.error, h = !_)) : (_ = k, (e || !k) && (k = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (i || k) + "", h ? g.resolveWith(p, [u, k, x]) : g.rejectWith(p, [x, k, _]), x.statusCode(v), v = void 0, c && f.trigger(h ? "ajaxSuccess" : "ajaxError", [x, d, h ? u : _]), m.fireWith(p, [x, k]), c && (f.trigger("ajaxComplete", [x, d]), --ot.active || ot.event.trigger("ajaxStop")))
            }
            ...
            if (g.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || he.href) + "").replace(/#.*$/, "").replace(/^\/\//, he.protocol + "//"), d.type = i.method || i.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(vt) || [""], null == d.crossDomain) {
                h = X.createElement("a");
                try {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), q(me, d, i, x), 2 === y) return x;
    ...
    ot.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !ot(this).is(":disabled") && xe.test(this.nodeName) && !we.test(t) && (this.checked || !Pt.test(t))
            }).map(function(t, e) {
                var i = ot(this).val();
...
function(t, e) {
    ...
    function l(e) {
        ...
        return a.removeClass(k + I).siblings(C + L).removeClass(k + L + I), r.length ? (i.find(C + O + " p").eq(r[0].index).addClass(k + H).siblings().removeClass(k + H), o.val(e).data("changed", !0), void n.val(e).change()) : (i.find(C + O + " p").removeClass(k + H), n.children().prop("selected", !1), s.invalidAsValue ? (s.highlightInvalid || (s.invalidAsValue ? s.highlightInvalid : null === s.highlightInvalid)) && a.addClass(k + I).siblings(C + L).addClass(k + L + I) : e = "", o.val(e), void a.val(e))
    }
    ...
    function h() {
        if (!this.data("listenersAdded")) {
            ...
            this.on("keyup", C + D + ", " + C + S, function(e) {
                if (!([38, 40, 13, 27, 9, 37, 39, 17, 18, 16, 20, 33, 34, 35, 36].indexOf(e.which) >= 0)) {
                    var i = function(e) {
                            if ((e.ctrlKey || e.shiftKey || 45 != e.which) && (!e.ctrlKey || 65 != e.which)) {
                                ...
                                var h = s.hideSeparatorsOnSearch ? "p" : "p:not(" + C + E + ", " + C + z + ")";
                                r.children(h).hide(), l.each(function() {
                                    ...
                                    if (s.filterIgnoreCase && (e = e.toLowerCase()), s.filterIgnoreAccents && String.prototype.latinize && (e = e.latinize()), i ? e.indexOf(a) >= 0 : 0 == e.indexOf(a)) {
                                        var o = s.filterIgnoreCase ? "i" : "",
                                            ...
                                            c = r.children("p:eq(" + l.index(this) + "):not(" + C + E + ", " + C + z + ")").show();
                                        n && c.each(function() {
                                            t(C + "-marker", this).contents().unwrap();
                                            var e = t(C + N, this)[0];
                ...
                if (clearTimeout(x), e.stopPropagation(), !t(this).is(C + E + ", " + C + z)) {
                    i.children(C + I).removeClass(k + I), i.children(C + L).removeClass(k + L + I);
                    var s = t(this),
                        n = s.parent(),
                        o = n.children(),
                        a = o.index(this);
                ...
                clearTimeout(x), e.stopPropagation();
                var n = t(this),
                    o = n.parent();
    ...
    function m() {
        ...
        }), !e && o ? (n.forbidInvalid ? i.closest(C).find(C + D).val("").data("value", "") : (n.highlightInvalid || (n.invalidAsValue ? n.highlightInvalid : null === n.highlightInvalid)) && i.addClass(k + I).siblings(C + L).addClass(k + L + I), n.invalidAsValue || i.siblings("select, " + C + T).val("")) : i.removeClass(k + I).siblings(C + L).removeClass(k + L + I)
    }
    ...
    function v(e, i) {
        if (!this.is(":animated") && this.length && ("up" != e || !this.is(":hidden") || 1 != this.length)) {
            ...
            }, this.slideUp(s).data("p-clicked-index", -1), n.children(C + W).removeClass(k + W + "-up")) : (o.beforeOpen.call(n), s.complete = function() {
                o.afterOpen.call(n)
            }, this.slideDown(s), n.children(C + W).addClass(k + W + "-up"), n.find(C + H).removeClass(k + H), t(C + "-marker", n).contents().unwrap(), n.children(C + O).children("p").show());
            n.children(C + D).each(function() {
                ...
                if (s.data("fillonarrow") && !i && s.data("fillonarrow", !1).val(s.data("value")), "down" == e) {
                    ...
                    r.each(function() {
                        var e = t(this).text().trim();
                        return o.filterIgnoreCase && (e = e.toLowerCase()), e == a ? (n.children(C + O).children("p:eq(" + r.index(this) + "):not(" + C + E + ", " + C + z + ")").first().addClass(k + H), !1) : void 0
                    })
                }
            })
        }
    ...
    function b(e, i) {
        for (var s = this.data(k), n = this.find("select"), o = this.find(C + O), a = 0; a < e.length; a++) {
            if (e[a].hasOwnProperty("separator")) {
                if (e[a].hasOwnProperty("header")) r = t('<p class="' + k + z + '" />').text(e[a].header);
    ...
    function w(t) {
        ...
        for (var e = Object.keys(t), i = 0; i < e.length; i++) {
            ...
            e[i] != s && (t[s] = t[e[i]], delete t[e[i]]), "object" == typeof t[s] && "data" != s && w(t[s])
        }
        return t
    }
    var x, k = "scombobox",
        ...
        R = {
            init: function() {
                var e = this.find(C + O),
                    ...
                    n = this.find(C + W),
                    o = this.data(k);
                if (this.addClass(k), 0 == i.length && this.append(t("<select />")), this.attr("id") && i.removeAttr("id"), i.attr("multiple") && (this.data(k).mode = "checkboxes"), 0 == s.length && this.append('<div class="' + k + L + '" />'), 0 == n.length && this.append('<div class="' + k + W + '" />'), R.displayDropdown.call(this, o.showDropDown), "checkboxes" != o.mode && 0 == this.find(C + D).length) {
            ...
            fill: function(e, i) {
                ...
                if (e ? (a.removeDuplicates && f(e), u(e), a.sort && (e.sort(p), a.sortAsc || e.reverse()), i || (o.empty(), n.empty(), this.children(C + T + ", " + C + D).val("")), b.call(this, e, 2 == i)) : (a.removeDuplicates && (g(s), d(s), s = this.find("select").children("option, optgroup")), 0 == s.length || s.each(function() {
                        var e = t(this),
                            i = t("<p />");
                        if (i.attr("title", e.attr("title")), e.hasClass(k + E)) e.hasClass(k + z) ? n.append(i.addClass(k + z).text(e.text())) : i.addClass(k + E);
                        else {
                            if ("optgroup" == this.tagName.toLowerCase()) {
                                var s = e.attr("label"),
                                    o = t("option", this);
                                return e.before("<option />"), e.after(o), e.remove(), n.append(s ? i.addClass(k + z).text(s) : i.addClass(k + E)), void o.each(function() {
            ...
            clear: function() {
                return this.children("select").empty(), this.children(C + O).empty().width(""), this.children(C + D).removeClass(k + I), this.children(C + L).removeClass(k + L + I), this
            },
            data: function(t) {
            ...
            disabled: function(t) {
                ...
                return 0 == arguments.length ? "checkboxes" == e ? this.hasClass(k + F) : this.children(C + D).prop("disabled") : (t = !!t, this.children(C + D).prop("disabled", t), t ? (this.addClass(k + F), this.children(C + L + ", " + C + W).hide()) : (this.removeClass(k + F), this.children(C + L + ", " + C + W).show()), this)
            },
            tabindex: function(t) {
                var e = this.find(C + D);
            ...
            options: function(e) {
                return 0 == arguments.length ? this.data(k) : (t.extend(!0, this.data(k), w(e)), this)
            },
            val: function(t) {
                var e = this.data(k),
                    i = e.mode;
            ...
            clickDropdown: function(t, e) {
                return s.call(this, "click", this.children(C + W), t, e)
            },
            toSelect: function() {
            ...
            displayDropdown: function(t) {
                return arguments.length ? t ? this.children(C + W + ", " + C + L).show() : this.children(C + W + ", " + C + L).hide() : this.data(k).showDropdown ? this.children(C + W + ", " + C + L).show() : this.children(C + W + ", " + C + L).hide(), this
            },
    ...
    t.fn[k] = function(e) {
        if ("string" == typeof e) {
            ...
            var s = t.extend(!0, {}, t.fn[k].defaults, w(e))
        }
...
function() {
    ...
    function(t) {
        ...
        t.extend(s.prototype, {
            ...
            _generateHTML: function(t) {
                var e, i, s, n, o, a, r, l, h, c, u, d, p, f, g, m, v, _, b, y, w, x, k, C, D, T, I, S, P, M, A, O, N, H, E, z, L, W, F, j = new Date,
                ...
                for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = Y ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : $ ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = Y ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>" : $ ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : R, a = Y ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (q ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (q ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; x < U[0]; x++) {
                    for (k = "", this.maxRows = 4, C = 0; C < U[1]; C++) {
                        ...
                        for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? q ? o : s : "") + (/all|right/.test(T) && 0 === x ? q ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", S = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; w < 7; w++) P = (w + c) % 7, S += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P] + "'>" + p[P] + "</span></th>";
    ...
    function(t, e) {
        ...
        $(".account-header__description-input").labelauty(), $(".account-payment__agree-input").labelauty(), $(".account-payment__accept-input").labelauty(), $(".account-capabilities__heading").click(function() {
        ...
        }), changeOptGroup(), customCheckbox("multiselect_category");
        var e = $("#attributes");
        e.multiselect({
            header: !0,
            noneSelectedText: "Attributes"
        }), customCheckbox("multiselect_attributes"), e.bind("multiselectcheckall", function(t, e) {
            customCheckboxCheckAll("multiselect_attributes", !0)
        }), e.bind("multiselectuncheckall", function(t, e) {
            customCheckboxCheckAll("multiselect_attributes", !1)
            ...
            showDropDown: !1,
            placeholder: "More"
        }), $("#selectSubCategory4").scombobox({
            filterDelay: 300,
            highlight: !0,
            filterIgnoreCase: !0,
            fillOnTab: !0,
            showDropDown: !1,
            placeholder: "All Subcategory"
        }), $("#selectSize4").scombobox({
            filterDelay: 300,
            highlight: !0,
            filterIgnoreCase: !0,
            fillOnTab: !0,
		...
		$('select[name="payment"]').change(function() {
            var t = $(this).val();
            console.log(t), "Chek" == t && ($("#paymentpaychek").css("display", "block"), $("#paymentpaypal").css("display", "none"), $("#paymentbank").css("display", "none"), $("#paymentindividual").css("display", "none"), $("#paymentcompany").css("display", "none")), "PayPal" == t && ($("#paymentpaychek").css("display", "none"), $("#paymentpaypal").css("display", "block"), $("#paymentbank").css("display", "none"), $("#paymentindividual").css("display", "none"), $("#paymentcompany").css("display", "none")), "BankAccount" == t && ($("#paymentpaychek").css("display", "none"), $("#paymentpaypal").css("display", "none"), $("#paymentbank").css("display", "block"), $("#paymentcompany").css("display", "block"), $("#paymentindividual").css("display", "none"))
