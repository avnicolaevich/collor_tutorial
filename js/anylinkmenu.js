...
var anylinkmenu = {
    ...
    effects: {
        ...
        fade: {enabled: false, duration: 500}
    ...
    getmenuHTML: function (menuobj) {
        ...
        for (var i = 0; i < menuobj.items.length; i++) {
            ...
            if (typeof menuobj.items[i][2] == "undefined" || menuobj.items[i][2] == "" || menuobj.items[i][2] == "efc") {
                frag += '<li><a href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '">' + menuobj.items[i][0] + '</a></li>\n'
            }
            else {
                frag += '<li><a href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '" id="' + menuobj.items[i][2] + '">' + menuobj.items[i][0] + '</a></li>\n'
            }
